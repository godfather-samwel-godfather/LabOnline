...
$rejectedCount = $appointmentRepo->countByPatientAndStatus($patientId,'rejected');
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                Manage your laboratory appointments and track progress.
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge bg-light text-dark px-3 py-2">
                            ...
                            <?= e(
$labTestRepo->getNamesByAppointmentId((int)$row['id'])
) ?>
                    ...
                    <td>
                        ...
                        <div class="alert alert-danger mt-2 mb-0 small">
                            ...
                            <?= e($row['rejection_reason'] ?? 'No reason provided') ?>
                    ...
                    <td>
                        ...
                        <a href="?page=create_appointment&rebook=<?= $row['id'] ?>" class="btn btn-warning btn-sm">
                        ...
                        <?php elseif($row['status']==='approved'): ?> <span class="text-success small">


                            <i class="bi bi-check-circle"></i>


                            Approved - Visit Laboratory
